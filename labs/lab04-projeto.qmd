---
title: "Lab 4: Projeto Final — Office Hours"
...
# Baixar dados
ativo = 'PETR4.SA'
precos = yf.download(ativo, start='2018-01-01', auto_adjust=False, progress=False)['Adj Close'].squeeze()
...
precos_pair = yf.download(ativos_pair, start='2018-01-01', auto_adjust=False, progress=False)['Adj Close'].dropna()
...
hedge_ratio = modelo_ols.params.iloc[0]
