...
Uma série temporal é uma realização de um **processo estocástico** $\{Y_t\}_{t \in T}$, onde cada $Y_t$ é uma variável aleatória e $T$ é o conjunto de índices temporais. O que observamos (os dados) é apenas **uma trajetória** dentre infinitas possíveis desse processo.

Essa distinção é crucial: quando ajustamos um modelo, estamos tentando recuperar as propriedades do *processo* a partir de uma *única realização*.
:::
